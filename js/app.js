window.onload = function(){
    ...
    botonIngresar = document.getElementById("btnIngresar");
...
botonRegistrar.addEventListener("click", function(){
    ingreso.style.display = "none";//para que no aparezca
    registro.style.display = "block";//para mostrarlo
}); //Sirve para ligar cualquier evento
...
btnRegistro.addEventListener("click",function(){
    ...
    fetch("http://tpapvjr.orgfree.com/registro.php", {
        method: 'POST',
        body: datos
    })
...
botonIngresar.addEventListener("click",function(){
    ...
    fetch("http://tpapvjr.orgfree.com/ingreso.php", {
    ...
    function cerrarBarra(){
     ...
     enviarM.addEventListener("click",function(){
        ...
        fetch("http://tpapvjr.orgfree.com/guardarMensaje.php", {
            method: 'POST', //*GET, POST,PUT, DELETE, ETC.
            body: datos
        })
        .then (function(response){
    ...
    function leerM(){
        ...
        fetch("http://tpapvjr.orgfree.com/leerMensaje.php", {
            method: 'POST', //*GET, POST,PUT, DELETE, ETC.
            body: datosLM
        })
        .then (function(response){
